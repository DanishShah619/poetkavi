            ...
            <div className="relative z-10 p-8">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-cyan-500/5 to-blue-500/5 pointer-events-none opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
                </div>
                ...
                <div className="mt-6 space-y-3">
                  <button
                    type="submit"
                    disabled={loading || googleLoading}
                    className="w-full relative group overflow-hidden rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 p-4 text-white font-semibold transition-all duration-300 hover:from-cyan-500 hover:to-blue-500 hover:shadow-lg hover:shadow-cyan-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:from-cyan-600 disabled:hover:to-blue-600"
                  >
              ...
              <div className="mt-6 text-center">
                <p className="text-slate-400 text-sm">
                  ...
                  <a
                    href="/signup"
                    className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200 focus:outline-none focus:underline"
                  >
                    Sign up
                  </a>
                </p>
